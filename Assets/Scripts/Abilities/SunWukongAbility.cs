    ...
    public override void Activate(UnitCard c, ActivationInfo Info)
    {
        if (Info.OverkillDamage > 0) {
            ...
            if(c.CurrentTeam == Team.Player) {
                AnimationManager.Instance.DamagePlayerAnimation(Info.Duel, Info.Duel.EnemyStatus);
                ...
                AnimationManager.Instance.DamagePlayerAnimation(Info.Duel, Info.Duel.PlayerStatus);
